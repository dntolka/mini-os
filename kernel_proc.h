...
typedef struct p_thread_control_block {
  ...
  Tid_t tid; // faster search
  PCB* pcb;
  TCB* tcb;  /**< The main thread */
  ...
  EXIT_STATE exited;  /**< Exit state*/
  DETACH_STATE detached;  /**< detach state */
  CondVar exit_cv;  /**< condition variable for WaitChild*/
