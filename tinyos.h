...
typedef struct pipe_control_block{
  ...
  CondVar has_space; // writer does kernel_wait, reader wakes up writer
  CondVar has_data;  // reader does kernel_wait, writer wakes up reader
...
int reader_read(void* reader, char* buf, unsigned int size);
int writer_write(void* writer, const char* buf, unsigned int size);
